...
function inputPlayer2() {   //input jugador2
    do {
        do {
            ...
            // console.log(typeof(input2) +" "+ input2 +" and is NaN : "+isNaN(input2));
        } while (input2 <= 0 || input2 > 6)
    } while (isNaN(input2))               //When input2 is string == NaN 
}

function testWinner() { //comprobar empate o ganador
    // console.log(typeWinArr1.indexOf(input1+input2)); //win player1
    // console.log(typeWinArr2.indexOf(input1+input2)); //win player2
